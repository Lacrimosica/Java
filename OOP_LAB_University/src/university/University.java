...
public class University {
	...
	public String student(int id){
		...
		if (id <STUDENT_ID_OFFSET || id >SCOUNT + STUDENT_ID_OFFSET) {
			System.err.println("Error, Such ID doesn't exist");
			return "Student exceeded";
		}else {
		return this.students[index].getId() + " " + students[index].getName();
	}
	...
	public int activate(String title, String teacher){
		...
		//System.out.println("activate puts out: " + courses[CCOUNT-1].getCode());
		
		return courses[CCOUNT-1].getCode(); 
	...
	public String listAttendees(int courseCode){
		System.out.println("this down here is the listattendees");
		int index = courseCode-COURSE_CODE_OFFSET;
	
		return this.courses[index].getStudents().toString() ;
	}
	...
	public String studyPlan(int studentID){
		System.out.println("this down here is the study plan");
		int index = studentID-STUDENT_ID_OFFSET;
		
		return this.students[index].getCourses().toString();
	}
}
